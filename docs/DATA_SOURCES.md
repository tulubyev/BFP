...
- **Маска постоянных источников тепла** (`backend/services/firmsHistory/staticSources.ts`, метод
  ...
  в одном и том же месте изо дня в день. Маска строится **только по нашей истории**
  `gis.fire_hotspots` (сторонних каталогов факелов и их лицензий нет). Место — статический
  ...
  - Пока истории меньше 8 дней (запись идёт с 2026-09-25), не маскируется ничего. Слой
    термоточек FIRMS 24 ч на карте маска не фильтрует.
